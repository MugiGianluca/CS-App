...
export class ListPage implements OnInit {
  ...
  constructor(private _playersService: JugadoresService,private _equiposService: EquiposService, public alertController: AlertController) {}
...
async  handleDeleteUser() {
  ...
  await this._playersService.EraseData()
    .subscribe(res => {
      this.players = res.data;
  ...
  async GetTeams(id_user:string){
    await this._equiposService.handleGetTeams()
      .subscribe(res => {
        this.players = res.data;
